  ...
  <>
    ...
    <div className={style.para}>
      <motion.p variants={fadeIn('', '', 0.5, 1)} className={style.text}>
        ...
        {' '}
        enthusiastic Senior Full Stack Developer with 9 years of experience building scalable, data-driven web applications. Expert in React, Node.js, Python, Next.js and cloud infrastructure. Proven ability to lead teams, improve efficiency by 30%, and drive user engagement by 45%. Passionate about delivering high-quality solutions impacting millions. I thrive on delivering state-of-the-art software solutions. When I&apos;m not coding, you&apos;ll find me exploring the fascinating worlds of Math, Movies, and Music.
      </motion.p>
      <motion.p variants={fadeIn('', '', 1, 1)} className={style.text}>
        ...
        {' '}
        <a
          href="https://github.com/venus1213"
          target="_blank"
          className={style.link}
          rel="noreferrer"
        >
